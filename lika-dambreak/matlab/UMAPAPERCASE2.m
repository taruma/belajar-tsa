...
% --Water Elevation
h1 = 15;     % Upstream head in (meter) elevation
h2 = h1;    % Downstream head in (meter) elevation

% --Channel Properties
km = 20;
lf = km * 1000;  % Length of channel in (meter)
...
% -- Time
jam = 3; detik = 3*3600;
time = detik;       % Duration simulation in seconds
...
% INPUT
kmberubah = 5; 
lc = kmberubah * 1000;    % Length of contraction in (meter) from left
b1 = 5;     % Width b1
b2 = b1;    % Width b2
...
% Input
chan_up = h1 - 5;              % Channel elevation at grid 1 (left)
slope1 = 0;          % '-' mean ascending
slope2 = chan_up/(lf-lc);            % 
